...
public class ConversationActivity extends AppCompatActivity {
  ...
  private FloatingActionButton flashActionFab;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    flashActionFab = (FloatingActionButton) findViewById(R.id.flash_action_fab);
  ...
  protected  void onResume() {
     ...
     */
    if (localVideoTrack == null && checkPermissions() && cameraCapturer != null) {
...
//    speakerActionFab.setOnClickListener(speakerClickListener());
    ...
    flashActionFab.show();
    flashActionFab.setEnabled(false);
    flashActionFab.setOnClickListener(flashClickListener());
  }
  ...
  private Room.Listener roomListener() {
    return new Room.Listener() {
      ...
      public void onConnected(Room room) {
        ...
        videoStatusTextView.setText("Waiting on client to join");
      ...
      public void onParticipantDisconnected(Room room, Participant participant) {
        videoStatusTextView.setText("Client disconnected");
      ...
      public void onClick(View v) {
        if (cameraCapturer != null) {
          ...
          if (cameraSource == CameraSource.FRONT_CAMERA) {
            ...
            flashActionFab.setEnabled(true);
          } else {
			// Switched to front camera
            flashActionFab.setEnabled(false);
			if (flashOn) {
	            flashOn = false;
	            updateFlashActionFab();
			}
          }
        }
      }
      ...
      public void onClick(View v) {
        ...
        if (localVideoTrack != null) {
          ...
          if (enable) {
            ...
            switchCameraActionFab.show();
            showToast("Video turned on.");
          } else {
            icon = R.drawable.ic_video_off;
            switchCameraActionFab.hide();
            showToast("Video turned off.");
          }
...
//            R.drawable.ic_volume_down_green_24px));
  ...
  private View.OnClickListener flashClickListener() {
    return new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        toggleFlash();
  ...
  private void updateFlashActionFab() {
    flashActionFab.post(new Runnable() {
      @Override
      public void run() {
        if (flashOn) {
          flashActionFab.setImageDrawable(ContextCompat.getDrawable(ConversationActivity.this, R.drawable.ic_flash_on));
          showToast("Flash turned on.");
        } else {
          flashActionFab.setImageDrawable(ContextCompat.getDrawable(ConversationActivity.this, R.drawable.ic_flash_off));
